...
const forecast = (latitude, longlitude ,callback) => {
    //adding lattitude and longlitude into api url

    const url = 'http://api.weatherstack.com/current?access_key=f5d29fe99e3d251369840b4f1baa08d0&query=' + encodeURIComponent(latitude) + ',' + encodeURIComponent(longlitude) + 'units=m'
